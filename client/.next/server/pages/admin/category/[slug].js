...
const ReactQuill = (0,next_dynamic__WEBPACK_IMPORTED_MODULE_1__["default"])(null, {
    loadableGenerated: {
        modules: [
            "admin\\category\\[slug].js -> " + "react-quill"
        ]
    },
    ssr: false
});
const Update = ({ oldCategory , token  })=>{
    ...
    const { 0: content , 1: setContent  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(oldCategory.content);
    const { 0: imageUploadButtonName , 1: setImageUploadButtonName  } = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)('Update image');
    const { name: name1 , success , error: error1 , image , buttonText , imagePreview  } = state;
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_3___default().put(`${_config__WEBPACK_IMPORTED_MODULE_5__/* .API */ .bl}/category/${oldCategory.slug}`, {
                name: name1,
                content,
                image
            }, {
    ...
    const updateCategoryForm = ()=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
...
Update.getInitialProps = async ({ req , query , token  })=>{
    const response = await axios__WEBPACK_IMPORTED_MODULE_3___default().post(`${_config__WEBPACK_IMPORTED_MODULE_5__/* .API */ .bl}/category/${query.slug}`);
    return {
        oldCategory: response.data.category,
        token
    };
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_withAdmin__WEBPACK_IMPORTED_MODULE_8__["default"])(Update));
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,152,212,789,398], () => (__webpack_exec__(2010)));
