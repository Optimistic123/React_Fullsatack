...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_helpers_auth__WEBPACK_IMPORTED_MODULE_4__, _components_Layout__WEBPACK_IMPORTED_MODULE_2__]);
([_helpers_auth__WEBPACK_IMPORTED_MODULE_4__, _components_Layout__WEBPACK_IMPORTED_MODULE_2__] = __webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__);
...
const Create = ({ token  })=>{
    ...
    const loadCategories = async ()=>{
        const response = await axios__WEBPACK_IMPORTED_MODULE_3___default().get(`${_config__WEBPACK_IMPORTED_MODULE_5__/* .API */ .bl}/categories`);
        setState({
            ...state,
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const response = await axios__WEBPACK_IMPORTED_MODULE_3___default().post(`${_config__WEBPACK_IMPORTED_MODULE_5__/* .API */ .bl}/link`, {
                title,
                url,
                categories,
                type,
            ...
            children: [
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                        ...
                        type: "submit",
                        children: (0,_helpers_auth__WEBPACK_IMPORTED_MODULE_4__/* .isAuth */ .$D)() || token ? 'Post' : 'Login to post'
                    })
                })
            ]
        })
...
Create.getInitialProps = ({ req  })=>{
    const token = (0,_helpers_auth__WEBPACK_IMPORTED_MODULE_4__/* .getCookie */ .ej)('token', req);
    return {
        token
    };
};
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,212,789], () => (__webpack_exec__(6101)));
