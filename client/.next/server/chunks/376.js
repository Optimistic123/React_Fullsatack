...
const withUser = (Page)=>{
    const WithAuthUser = (props)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(Page, {
            ...props
        })
    ;
    WithAuthUser.getInitialProps = async (context)=>{
        ...
        if (token) {
            try {
                const response = await axios__WEBPACK_IMPORTED_MODULE_1___default().get(`${_config__WEBPACK_IMPORTED_MODULE_2__/* .API */ .bl}/user`, {
                    headers: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (withUser);
